...
import { bulkCreateCourse, getCourses } from "../db/Course/Service";
...
// ***** CREATE BULK COURSES ***** //
export const createAllCourses = async (req: Request, res: Response) => {
  try {
    const createdCourses = await bulkCreateCourse(courses);
